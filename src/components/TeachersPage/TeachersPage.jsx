...
export default function TeachersPage() {
  ...
  const visibleTeachersList = useMemo(
    () => allTeachers.slice(0, visibleTeachers),
    ...
    <WraperBox>
      <TeachersPageContainer>
        <FilterMenu
          ...
          onResultsFoundChange={handleResultsFoundChange}
        ...
        {!resultsFound && (
          <NotFound>These are all teachers who meet your criteria</NotFound>
        )}

        {visibleTeachersList.length < visibleTeachers ? null : resultsFound ? (
