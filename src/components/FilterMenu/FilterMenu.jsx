...
export default function FilterMenu({
      ...
      try {
        ...
        if (snapshot.exists()) {
          ...
          const uniqueLanguages = Array.from(
            new Set(teachersArray.flatMap(teacher => teacher.languages))
          );
          const uniqueLevels = Array.from(
            new Set(teachersArray.flatMap(teacher => teacher.levels))
          );
          const uniquePrice = Array.from(
            new Set(teachersArray.flatMap(teacher => teacher.price_per_hour))
          );
          ...
          const filteredTeachers = teachersArray.filter(teacher => {
            ...
            const filterByLevel = selectedLevels
              ...
              : true;
            const filterByPrice = selectedPrices
  ...
  return (
    <WraperMenu>
      ...
      {selectedLanguage || selectedLevels || selectedPrices ? (
